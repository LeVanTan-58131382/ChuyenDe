...
<body>
    ...
    <div class="ad">
        <div class="ad-part-left">
            <ul>
                <li id="li1">Admin</li>
                <a href="{{ route('list-cus')}}"><li id="li2">Khách Hàng</li></a>
                <a href="{{ route('list-calBill')}}"><li id="li3">Thanh Toán Dịch Vụ</li></a>
                <a href="{{ route('list-notifi')}}"><li id="li4">Thông Báo</li></a>
                <a href="{{ route('statistical')}}"><li id="li5">Thống kê</li></a>
                <a href="{{ route('list-cmt-ad')}}"><li id="li5">Bình luận</li></a>
        ...
        <div class="ad-part-right">
            <div class="ad-menu-right">
                <ul>
                    ...
                    <a href="{{ route('list-mes')}}"><li id="li9">Tin nhắn</li></a>
